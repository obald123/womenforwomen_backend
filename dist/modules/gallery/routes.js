...
router.post("/", upload_1.upload.array("images", 10), (0, validate_1.validate)(gallery_1.createGallerySchema), (0, asyncHandler_1.asyncHandler)(controller_1.createGallery));
