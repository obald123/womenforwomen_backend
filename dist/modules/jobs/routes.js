...
router.post("/", upload_1.uploadDocs.fields([{ name: "descriptionFile", maxCount: 1 }]), (0, validate_1.validate)(jobs_1.createJobSchema), (0, asyncHandler_1.asyncHandler)(controller_1.createJob));
...
router.patch("/:id", upload_1.uploadDocs.fields([{ name: "descriptionFile", maxCount: 1 }]), (0, validate_1.validate)(jobs_1.updateJobSchema), (0, asyncHandler_1.asyncHandler)(controller_1.updateJob));
